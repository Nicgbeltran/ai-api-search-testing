...
def openai_gpt4_1m_search(company_name: str, company_address: str, system_prompt: str, user_prompt: str):
    ...
    try:
        ...
        response = client.responses.create(
            ...
            tools=[{"type": "web_search_preview", "search_context_size": "medium"}], # Enable the web search tool
...
def openai_gpt4_1h_search(company_name: str, company_address: str, system_prompt: str, user_prompt: str):
    """Sends a query to the OpenAI API using gpt-4.1 with web search enabled."""
    print("OpenAI GPT-4.1 Search") # Indicate which function is running
    client = OpenAI()
    ...
    try:
        ...
        response = client.responses.create(
            model="gpt-4.1",                   # Specify the model
            tools=[{"type": "web_search_preview", "search_context_size": "high"}], # Enable the web search tool
